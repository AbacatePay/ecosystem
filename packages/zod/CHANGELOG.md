...
All notable changes to `@abacatepay/zod` are documented in this file.
...
- `APISubscription.frequency.dayOfProcessing` was a sibling field instead of being nested inside `frequency` (typebox already had this right).
